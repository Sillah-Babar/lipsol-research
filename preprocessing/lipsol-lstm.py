...
class Video(object):
    ...
    def process_frames_face(self, frames):
        ...
        if len(mouth_frames)>96 :
            mouth_frames = mouth_frames[0:96]
            # sub=96-len(mouth_frames)
            # odd=False
            # new_sub = int(sub / 2)
            # if sub%2==0:
            #     odd=False
    ...
    def get_frames_mouth(self, frames):
        ...
        for i in range(len(frames)):
            ...
            lipsx,lipsy,lips_z = self.ApplyModel(frames[i])
            array=np.array([lipsx,lipsy,lips_z],dtype='float')
            fname.append(array)
        return fname
...
if __name__ == '__main__':
    ...
    CURRENT_PATH = r'D:\Downloads\dataset\0\0\*\*'
